...
main( int argc, char *argv[] )
{
  ...
  }//end of parse parameters, by guangwei
  ...
  //long  endTime           = clock();
  long  endTime           = WelsTime(); // by guangwei on Nov. 3,2015
  ...
  double deltaInSecond = (double)( endTime - startTime) / 1e6; // by guangwei 
